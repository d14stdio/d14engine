...
#ifdef _DEBUG
            Wstring vsPdbPath = app->createInfo.resourcePath + L"Shaders/PDB/ColorfulCube_VS.pdb";
            Wstring psPdbPath = app->createInfo.resourcePath + L"Shaders/PDB/ColorfulCube_PS.pdb";
